...
- 본문이 완전히 끝난 후, 반드시 아래 형식을 **정확히** 따라야 함
- 프론트엔드에서 에메랄드색 카드로 강조 표시됨
- **형식을 조금이라도 바꾸면 파싱이 실패합니다**
...
8. **[절대 필수] 요점 정리**:
   ...
   - **반드시 아래 형식을 정확히 따르세요** (형식이 다르면 파싱 실패):
...
- **[필수] 모든 슬라이드는 100% 반드시 아래 형식으로 끝나야 합니다:**
  "---\\n\\n📌 요점 정리:\\n- 항목1\\n- 항목2\\n- 항목3"
- **[금지] 요점 정리에 "★"나 "·" 기호 사용 금지. 반드시 "-" 하이픈만 사용**
